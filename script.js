...
const MODES = {
  windows: {
    ...
    hero: {
      ...
      subtitle: "Ремонт, регулювання та утеплення вікон для квартир, будинків і комерційних приміщень.",
      cta: "Отримати прорахунок",
      secondary: "Як ми працюємо",
      floatingCta: "Зв'язатися з нами",
      headerCta: "Зв'язатися з нами",
      stats: [
        ["draftStop", "Усунення протягів"],
    ...
    services: [
      ["settings", "Сервіс вікон", "Ремонт, регулювання, ущільнення та профілактика механізмів.", "./assets/img/services/window-service.webp"],
      ...
      ["window", "Москітні сітки", "Виготовлення та встановлення сіток під розмір ваших вікон.", "./assets/img/services/mosquito-nets.webp"],
      ["tools", "Заміна вікон", "Металопластикові системи для квартир, будинків і комерційних приміщень.", "./assets/img/services/window-replacement.webp"]
    ],
    why: {
      label: "Чому ми",
      title: "Чому обирають нас",
      text: "Ми повертаємо вашим вікнам тепло, тишу та ідеальну роботу, без пилу та зайвих витрат.",
      points: [
        "Досвідчені монтажники та контроль якості",
        "Ліквідуємо продування, промерзання та шум, за один візит",
  ...
  conditioners: {
    ...
    promo: {
      ...
      title: "-20% на обслуговування кондиціонерів",
      text: "Зафіксуємо вигідну ціну на сервісне обслуговування та підкажемо, що потрібно саме вашій системі. Ваш кондиціонер запрацює як новий вже сьогодні.",
      discount: "-20%",
    ...
    why: {
      ...
      points: [
        ...
        "Чистий, швидкий та якісний монтаж",
    ...
    reviews: {
      title: "Що говорять клієнти про нас",
    ...
    faq: {
      ...
      items: [
        [
          "Чи допомагаєте підібрати кондиціонер?",
          "Так, ми підбираємо модель за параметрами приміщення, висотою стелі, кількістю кімнат, сонячною стороною та сценарієм використання."
        ],
        [
...
function renderHero(mode) {
  ...
  qs("#promo-topbar-cta").textContent = config.headerCta;
