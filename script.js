...
const MODES = {
  windows: {
    ...
    services: [
      ...
      ["sparkle", "Скління балконів", "Тепле та холодне скління з акуратною геометрією."],
      ["shield", "Сервіс та регулювання", "Фурнітура, ущільнювачі, діагностика і дрібний ремонт."],
      ["wrench", "Монтаж під ключ", "Демонтаж, доставка, встановлення і завершальні роботи."]
    ],
    why: {
      label: "Чому ми",
      ...
      points: [
        ...
        "Працюємо з квартирами, будинками і балконами",
